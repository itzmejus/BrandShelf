  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-10 py-16 space-y-6">
      ...
      <div className="space-y-4 text-sm text-on-surface-variant leading-relaxed">
        <p>
          By using this website, you agree to use it only for lawful purposes. Prices, availability, and
          business details shown here are subject to change without notice.
        </p>
        <p>
          For questions about an order, appointment, or service, please contact us using the details
