      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-primary px-8 py-7 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-xl font-bold text-white">Set up your storefront.</h2>
            <p className="text-sm text-on-primary-container mt-1">
              A few details and your BrandShelf digital storefront will be ready to share. You can add your logo, images, and opening hours in Settings later.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="px-8 py-5 bg-surface-container-low border-t border-outline-variant flex items-center justify-between gap-4">
            <p className="text-xs text-on-surface-variant leading-tight">
              Your storefront goes live instantly. Update your profile, add images, and set opening hours in Settings at any time.
            </p>
            <Button type="submit" loading={saving} size="lg" className="flex-shrink-0">
              {saving ? 'Creating storefront…' : 'Create Storefront'}
            </Button>
          </div>
        </form>
      </div>
